...
parser.add_argument('--data_dir', type=str, default="/scratch/ssd004/scratch/snajafi/datasets/UltraFeedback",
                    help='Directory containing the data')
parser.add_argument('--model', type=str, default="/scratch/ssd004/scratch/snajafi/model-weights/llama3.2-1b-sftdatasetv3-sft-checkpoint-111000",
...
parser.add_argument('--seed', type=int, default=42,
                    help='Random seed')
parser.add_argument('--output_dir', type=str, default="/scratch/ssd004/scratch/snajafi/datasets/llama-3.2-1b-offline-preference-data",
                    help='output_dir')
...
prompts = sorted(list(set(train_dataset['instruction'])))
