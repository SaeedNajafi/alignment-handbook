...
def human_eval_docstrings() -> List[str]:
    ds = load_dataset("/home/saeednjf/nearline/rrg-afyshe/datasets/openai_humaneval/openai_humaneval", split="test")
...
FILTER_OUT = {
    ...
    "human_eval_solutions": [
        s
        for s in load_dataset_column("/home/saeednjf/nearline/rrg-afyshe/datasets/openai_humaneval/openai_humaneval", "canonical_solution", "test")
